# -*- coding: utf-8 -*-
"""
Created on Tue Feb 18 08:58:13 2020
...
rowkey=[int(i)-1 for i in rowkey ]
columnkey=[int(i)-1 for i in columnkey ]
print(rowkey)
print(columnkey)
